...
public class Amazonas_Alagoas extends AppCompatActivity {
    ...
    private ArrayList<TemBusLayoutAdapter> adicionarOnibus() {
        ...
        e = new TemBusLayoutAdapter("21:05             21:40", "");
        onibusTestes.add(e);

        e = new TemBusLayoutAdapter("22:15             22:50", "");
        onibusTestes.add(e);

        e = new TemBusLayoutAdapter("23:25             23:50", "");
        onibusTestes.add(e);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.petroita_amazonas__alagoas);
